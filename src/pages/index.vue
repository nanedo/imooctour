  ...
  <div class="index-wrap">
    <div class="index-left">
      <div class="index-left-block">
        <h2>全部产品</h2>
        <template v-for="(product, name) in productList">
          ...
          <div class="hr" v-if="!product.last" :key="product.last"></div>
        </template>
      </div>
    ...
    <div class="index-right">
      ...
      <!-- 不能用@简写符号绑定事件 -->
      <slider-show :slides="slides" :inv="invTime" v-on:doSomethingByEmit="doSomething"></slider-show>
      <div class="index-board-list">
        <div class="index-board-item" v-for="(item, index) in boardList" :key="index" :class="[{'line-last': index % 2!==0}, 'index-board-' + item.id]">
          <div class="index-board-item-inner">
            ...
            <div class="index-board-button" v-if="!item.saleout">
...
export default {
  created: function () {
    // this.$http.delete('api/getNewsList/6')
    ...
    // this.$http.get('api/getNewsList?url_like=baidu').then(res => {
      console.log('res:', res)
